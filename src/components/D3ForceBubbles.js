...
import { data } from "./D3ForceBubblesData";
import "./D3ForceBubbles.css";
// import axios from "axios";
// import { connect } from "react-redux";
// import { setUser } from "../../ducks/reducer";
// import { withRouter } from "react-router-dom";

export default class D3ForceBubbles extends Component {
  componentDidMount() {
    this.forceBubbles();
  }
  ...
  forceBubbles = () => {
    ...
    // node
    //   .filter(d => !String(d.icon).includes("thumbs/"))
    //   .append("text")
    ...
    node
    //   .filter(d => String(d.icon).includes("require"))
      .append("image")
      .classed("node-icon", true)
      .attr("clip-path", d => `url(#clip-${d.id})`)
